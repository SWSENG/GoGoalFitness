...
class ShoulderStatusAdapter (val items : ArrayList<ShoulderModel>, val context: Context) : RecyclerView.Adapter<ShoulderStatusAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ShoulderModel = items[position]
