...
class ArmStatusAdapter (val items : ArrayList<ArmModel>, val context: Context) : RecyclerView.Adapter<ArmStatusAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ArmModel = items[position]
