...
class ChestStatusAdapter (val items : ArrayList<ChestModel>, val context: Context) : RecyclerView.Adapter<ChestStatusAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val model : ChestModel = items[position]
